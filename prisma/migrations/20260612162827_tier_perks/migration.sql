...
INSERT INTO "new_OfferTier" ("badge", "discountType", "id", "imageUrl", "labelText", "minQty", "offerId", "position", "preselected", "subtitle", "title", "valueX100") SELECT "badge", "discountType", "id", "imageUrl", "labelText", "minQty", "offerId", "position", "preselected", "subtitle", "title", "valueX100" FROM "OfferTier";
